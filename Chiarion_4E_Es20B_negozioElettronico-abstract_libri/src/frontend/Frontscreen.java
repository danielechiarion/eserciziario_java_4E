...
public class Frontscreen {
    ...
    public static Prodotto inputProdotto(Scanner scanner) throws Exception {
        ...
        String autore, titolo, argomento;
        ...
        if (sceltaDispositivo == 1 || sceltaDispositivo == 2) {
        ...
        if (sceltaDispositivo == 1) {
            ...
            /* inserimento dati di un manuale */
            System.out.println("Inserisci il titolo: ");
            titolo = scanner.nextLine();
            System.out.println("Inserisci l'autore: ");
            autore = scanner.nextLine();
            System.out.println("Inserisci la quantità: ");
            quantita = safeIntInput(scanner);
            System.out.println("Inserisci l'argomento: ");
            argomento = scanner.nextLine();

            return new Manuale(codiceProdotto, titolo, autore, prezzo, quantita, argomento);
        }
    }

    /* input di un prodotto solo per la ricerca */
    public static Prodotto inputProdottoRicerca(Scanner scanner) {
    ...
    public static int ricercaProdotto(Scanner scanner, GestoreNegozio negozio) throws Exception {
        Prodotto prodottoInput = inputProdottoRicerca(scanner);
